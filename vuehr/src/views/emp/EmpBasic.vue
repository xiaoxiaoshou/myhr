<template>
  <div>
    <div>
      <div style="display: flex;justify-content: space-between">
        <div >
          ...
          ></el-input>
          <el-button type="primary" :disabled="showAdvanceSearchView" icon="el-icon-search" @click="initEmps">搜索</el-button>
      ...
      <transition name="slide-fade">
        <div v-show="showAdvanceSearchView" style="border: 1px solid #409eff;border-radius: 5px;box-sizing: border-box;padding: 5px;margin: 10px 0">
          <el-row>
            <el-col :span="5">
              政治面貌：
          ...
          <el-row style="margin-top: 10px">
            <el-col :span="5">
              ...
              <el-popover
                ...
                <div slot="reference"
                     style="width: 130px;display: inline-flex;font-size: 13px;border: 1px solid #dedede;height: 26px;border-radius: 5px;cursor: pointer;align-items: center;padding-left: 8px;box-sizing: border-box;margin-left: 5px"
    ...
    <div style="margin-top: 10px">
      <el-table
        ...
        <el-table-column
          ...
          label="操作">
          <template slot-scope="scope">
            <el-button @click="showEditEmp(scope.row)" size="mini" style="padding: 3px">编辑</el-button>
            <el-button size="mini" style="padding: 3px" type="primary">查看资料</el-button>
            <el-button @click="deleteEmp(scope.row)" size="mini" style="padding: 3px" type="danger">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    <div style="display: flex;justify-content: flex-start">
      <el-button type="danger" @click="mulDelEmp" :disabled=" multiple">批量删除</el-button>
    </div>
    <el-dialog
      :title="title"
      ...
      width="80%">
     <div>
       <el-form style="text-align: left" :model="emp" :rules="rules" ref="empForm">
         <el-row>
           <el-col :span="6">
           ...
           <el-col :span="7">
             <el-form-item label="政治面貌：" prop="">
               <el-select style="width: 150px;" v-model="emp.politicId" placeholder="政治面貌 ">
                 <el-option
                   v-for="item in politicsstatus"
                   :key="item.id"
                   :label="item.name"
               ...
               <el-popover
                 ...
                 <el-tree :data="allDeps" default-expand-all :props="defaultProps" @node-click="handleNodeClick"></el-tree>
                  <div
                    slot="reference"
                    @click="showDepView"
                    style="width: 150px;cursor: pointer;display: inline-flex;font-size: 13px;border: 1px solid #dedede;height: 26px;border-radius: 5px;align-items: center;padding-left: 10px;box-sizing: border-box"
                  >
                    {{inputDepName}}
                  </div>
               </el-popover>
    ...
    methods:{
      mulDelEmp(){
        this.$confirm('此操作将删除['+this.multipleSelection.length+']条数据, 是否继续?', '提示', {
          ...
          this.deleteRequest('/employee/basic/'+this.multipleSelection).then(resp=>{
            if(resp){
              this.initEmps()
            }
          })
